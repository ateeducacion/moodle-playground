...
- Filenames follow: `SDD-NNNN-short-kebab-case-title.md` — for example
  `SDD-0001-editable-blueprint-panel.md`.
...
As with ADRs, technical claims should cite a verifiable source: a repository
path plus commit, official documentation, a benchmark, a reproducible
experiment, or a linked issue, PR or ADR. Keep the evidence inside the SDD;
this repository does not maintain a separate `sources/` or `experiments/` tree.
...
2. Fill in the design: problem, goals, non-goals, technical design,
   compatibility, security, accessibility, testing, rollout, risks and
   acceptance criteria.
...
- [ ] Compatibility, security, accessibility and testing are addressed.
