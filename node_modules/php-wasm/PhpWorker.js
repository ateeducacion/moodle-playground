...
var _phpWorker = _interopRequireDefault(require("./php-worker.js"));
...
var PhpWorker = exports.PhpWorker = /*#__PURE__*/function (_PhpBase) {
  function PhpWorker() {
    var args = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, PhpWorker);
    return _callSuper(this, PhpWorker, [_phpWorker["default"], args]);
  }
  _inherits(PhpWorker, _PhpBase);
  return _createClass(PhpWorker, [{
    ...
    value: function () {
      var _refresh = _asyncToGenerator(function* () {
        _superPropGet(PhpWorker, "refresh", this, 3)([]);
    ...
    value: function () {
      var _enqueue2 = _asyncToGenerator(function* (callback) {
        ...
        navigator.locks.request('php-wasm-fs-lock', /*#__PURE__*/_asyncToGenerator(function* () {
          ...
          yield _this.autoTransaction && !readOnly ? _this.startTransaction() : Promise.resolve();
          do {
          ...
          yield _this.autoTransaction ? _this.commitTransaction(readOnly) : Promise.resolve();
        }));
        return coordinator;
      });
